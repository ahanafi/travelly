         ...
         <div class="col-md-12">
            <div class="box">
               ...
               <div class="box-body">
                  <div class="row">
                     <div class="col-md-12">
                        <form action="<?= adminRoute('profile/create') ?>" method="post" class="form-group">
                           <div class="row">
                              <label for="profile" class="col-md-1 col-md-offset-1">Profile</label>
                              <div class="col-md-8">
                                 <input type="text" class="form-control" name="profile" autocomplete="off" required value="<?= set_value('profile') ?>">
                                 <?= form_error('profile') ?>
                              </div>
                           </div>
                           <br>
