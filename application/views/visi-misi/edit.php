         ...
         <div class="col-md-12">
            <div class="box">
               ...
               <div class="box-body">
                  <div class="row">
                     <div class="col-md-12">
                        <form action="<?= adminRoute('visi-misi/update/'.$visi_misi->id) ?>" method="post" class="form-group">

                           <div class="row">
                              <label for="visi" class="col-md-1 col-md-offset-1">Visi</label>
                              <div class="col-md-8">
                                 <input type="text" class="form-control" name="visi" autocomplete="off" required value="<?= $visi_misi->visi ?>">
                                 <?= form_error('visi') ?>
                              </div>
                           </div>
                           <br>
                           ...
                           <div class="row">
                              ...
                              <div class="col-md-8">
                                 <textarea name="misi" id="" cols="30" rows="10" class="form-control textarea"><?= $visi_misi->misi ?></textarea>
                                 <?= form_error('misi') ?>
                              </div>
                           </div>
                           <br>
                           ...
                           <div class="row">
                              ...
                              <div class="col-md-8">
                                 <textarea name="konten" id="" cols="30" rows="10" class="form-control textarea"><?= $visi_misi->konten; ?></textarea>
                                 <?= form_error('konten') ?>
                              </div>
                           </div>
                           <br>
